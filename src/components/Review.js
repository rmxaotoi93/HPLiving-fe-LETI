...
export default function Review() {
  ...
  const sendComment = async (e) => {
    ...
    const newReview = await axios.post(
      process.env.REACT_APP_SERVER + `/houses/${houseId}/reviews`,
      reviewData,
      {
        headers: {
    ...
    const fooReview = [...review, newReview.data.data];
    setReview(fooReview);
  ...
  const getReview = async (e) => {
    await axios
      .get(`${process.env.REACT_APP_SERVER}/houses/${houseId}/reviews`)
      .then((res) => {
            ...
            <Col className="each-review">
              ...
              <div className="review-flex">
                ...
                <div>
                  ...
                  <a
                    href="##"
                    style={{ color: "#d93025", marginRight: 30 }}
